...
def display_help():
    ...
    print("  move, mv <old_name> <new_name>   : Rename a directory from <old_name> to <new_name>.")
    ...
    # Display datas calculated.
    print("refer, rf -d <period>      : Refer daily transactions. Optionally specify a period (e.g., "
          "2023/01/01~2023/01/31).")
    print("refer, rf -m <period>      : Refer monthly transactions. Optionally specify a period. (e.g., "
          "2023/01/01~2023/01/31).")
...
class Shell:
    ...
    def refer_tree(self, command: list):
        ...
        def dfs_display(branch: Bc.Branch, depth: int):
    ...
    def move_dir(self, command):
        ...
        # 4. update json file
        Bc.modify_branch_name(self.branch, old_name, new_name)
